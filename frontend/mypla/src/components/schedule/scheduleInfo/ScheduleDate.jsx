      ...
      {!isEditable ? (
        <Box>
          <Typography variant="subtitle1">
            <strong>{clickedEvent?.extendedProps?.category === "recurrent" ? 'Día' : 'Fecha'}: </strong> 
            {clickedEvent?.extendedProps?.category === "recurrent" ? editDay : editDate.toLocaleDateString()}
          </Typography>
        </Box>  
        ) : (
