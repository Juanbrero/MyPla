    ...
    return (
        <div className="color-ref-container">
          <ul className="color-list">
            ...
            <li className="orange" data-tooltip="Horario creado para cancelar una franja horaria de un horario recurrente, en una fecha en particular.">Excepcion</li>
            <li className="yellow" data-tooltip="Eventos en los que se va a participar.">Eventos</li>
          </ul>
        </div>
    )
}