...
Revision ID: 9a635112893b
Revises: 
Create Date: 2025-06-20 21:02:43.606413
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['prof_id'], ['professional.prof_id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('day_hour', 'prof_id', 'invite_id', name='pk_invite')
    )
