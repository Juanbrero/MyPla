...
def reservation_class(prof_id: str, class_:schema_reservation.ReservationClassCtrl, db:Session = Depends(get_db)):#, user_info = Depends(RolesValidator(["Alumno"]))):
    """
    Creacion de una clase
    """
    reservationS = schema_reservation.ReservationClassIn(**class_.dict(), student_id= prof_id)
